            ...
            <main>
                <form >
                    ...
                    <div>
                        ...
                        <Editor editorStyle={{backgroundColor:"gray"}} wrapperStyle={{height:"30%"}} onChange={handleEditorInputChange}/> <br/> <br/><br/><br/><br/>         

                        <label>{t('description.title')} </label>
                        {/* <input type="text" name="username" value={event.description} onChange={handleInputChange}/> */}
                        <Editor editorStyle={{backgroundColor:"gray"}} wrapperStyle={{height:"30%"}}  onChange={handleEditorInputChange}/>
